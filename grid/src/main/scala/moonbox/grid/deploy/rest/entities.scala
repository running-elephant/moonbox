...
case class SubmitOutbound(jobId: Option[String] = None,
	...
	schema: Option[Seq[String]] = None, data: Option[Seq[Seq[String]]] = None) extends Outbound
...
case class ResultOutbound(jobId: String, error: Option[String] = None, schema: Option[Seq[String]] = None, data: Option[Seq[Seq[String]]] = None) extends Outbound
...
case class QueryInbound(token: String, sqls: Seq[String]) extends Inbound
case class QueryOutbound(error: Option[String] = None, schema: Option[Seq[String]] = None, data: Option[Seq[Seq[String]]] = None) extends Outbound
