...
import moonbox.grid.deploy.messages.Message.SchemaField
...
object Interface extends Interface {
  ...
  case class SchemaInbound(username: String, password: String, sqls: Seq[String], database: Option[String], analyzable: Option[Boolean]) extends Inbound

  case class SchemaOutbound(success: Boolean, message: Option[String] = None, result: Option[Seq[SchemaResult]] = None) extends Outbound

  case class SchemaResult(success: Boolean, message: Option[String] = None, `type`: Option[String] = None, fields: Option[Seq[SchemaField]] = None)
  ...
  case class LineageInbound(username: String, password: String, sqls: Seq[String], database: Option[String], analyzable: Option[Boolean]) extends Inbound
