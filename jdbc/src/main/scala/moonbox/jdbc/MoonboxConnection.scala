...
class MoonboxConnection(url: String, props: Properties) extends java.sql.Connection {
  ...
  override def getCatalog: String = jdbcSession.moonboxClient.getCurrentDatabase // TODO: get current database
  ...
  override def setAutoCommit(autoCommit: Boolean): Unit = {} /* commit is unsupported */
  ...
  override def getSchema: String = jdbcSession.moonboxClient.getCurrentDatabase // TODO: get current database
