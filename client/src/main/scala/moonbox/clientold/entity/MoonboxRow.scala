...
class MoonboxRow(values: Array[Any]){
  ...
  /**
    * Returns the value at position i of struct type as a [[MoonboxRow]] object.
    *
    * @throws ClassCastException when data type does not match.
    */
  def getStruct(i: Int): MoonboxRow = getAs[MoonboxRow](i)
  ...
  override def equals(o: Any): Boolean = {
    if (!o.isInstanceOf[MoonboxRow]) return false
    val other = o.asInstanceOf[MoonboxRow]
