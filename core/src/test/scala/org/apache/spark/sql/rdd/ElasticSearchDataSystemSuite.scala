...
import org.apache.spark.sql.datasys.ElasticSearchDataSystem
...
class ElasticSearchDataSystemSuite extends FunSuite with BeforeAndAfterAll{
    ...
    test("show") {
        ...
        val esDbSystem: ElasticSearchDataSystem = new ElasticSearchDataSystem(map)(spark)
    ...
    test("read") {
        ...
        val esTbSystem: ElasticSearchDataSystem = new ElasticSearchDataSystem(map)(spark)
        esTbSystem.buildScan(optimized).show(false) //test 1
    ...
    test("write"){
        ...
        val esTbSystem2: ElasticSearchDataSystem  = new ElasticSearchDataSystem(map2)(spark)
