...
private[kafka010] case class CachedKafkaConsumer private(
  ...
  private var fetchedData = ju.Collections.emptyIterator[ConsumerRecord[String, String]]
  ...
  def get(
    ...
    ConsumerRecord[String, String] = runUninterruptiblyIfPossible {
  ...
  private def fetchData(
      ...
      untilOffset: Long,
      pollTimeoutMs: Long,
      failOnDataLoss: Boolean): ConsumerRecord[String, String] = {
  ...
  private def resetFetchedData(): Unit = {
    ...
    fetchedData = ju.Collections.emptyIterator[ConsumerRecord[String, String]]
  }
