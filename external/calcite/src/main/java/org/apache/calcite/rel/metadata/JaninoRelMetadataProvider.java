...
public class JaninoRelMetadataProvider implements RelMetadataProvider {
    ...
    MetadataHandler<M> load3(MetadataDef<M> def,
        ...
        buff.append("  }\n")
                .append("  public edp.moonbox.calcite.rel.metadata.MetadataDef getDef() {\n")
                .append("    return ")
        ...
        for (Ord<Method> method : Ord.zip(def.methods)) {
            buff.append("  public ")
                    ...
                    .append("(\n")
                    .append("      edp.moonbox.calcite.rel.RelNode r,\n")
                    .append("      edp.moonbox.calcite.rel.metadata.RelMetadataQuery mq");
