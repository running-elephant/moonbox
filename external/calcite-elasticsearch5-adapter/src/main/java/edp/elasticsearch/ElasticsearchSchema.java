...
import edp.moonbox.calcite.schema.Table;
import edp.moonbox.calcite.schema.impl.AbstractSchema;
...
public class ElasticsearchSchema extends AbstractSchema {
  ...
  ElasticsearchSchema(Map<String, Integer> coordinates,
    ...
    final List<InetSocketAddress> transportAddresses = new ArrayList<InetSocketAddress>();
