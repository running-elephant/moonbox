...
import edp.moonbox.calcite.schema.Schema;
import edp.moonbox.calcite.schema.SchemaFactory;
...
public class ElasticsearchSchemaFactory implements SchemaFactory {
  ...
  //public static ElasticsearchSchemaFactory INSTANCE = new ElasticsearchSchemaFactory();
