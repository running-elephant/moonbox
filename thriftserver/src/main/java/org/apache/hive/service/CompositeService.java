...
public class CompositeService extends AbstractService {
  ...
  public synchronized void start() {
    ...
    try {
      ...
      // Note that the state of the failed org.apache.hive.service is still INITED and not
      // STARTED. Even though the last org.apache.hive.service is not started completely, still
      // call stop() on all services including failed org.apache.hive.service to make sure cleanup
      // happens.
      stop(i);
  ...
  public synchronized void stop() {
    if (this.getServiceState() == STATE.STOPPED) {
      // The base composite-org.apache.hive.service is already stopped, don't do anything again.
      return;
    }
