...
public abstract class AbstractService implements Service {
  ...
  /**
   * Service start time. Will be zero until the org.apache.hive.service is started.
   */
  private long startTime;

  /**
   * The configuration. Will be null until the org.apache.hive.service is initialized.
   */
  ...
  /**
   * Construct the org.apache.hive.service.
   *
   * @param name
   *          org.apache.hive.service name
   */
   ...
   *           if the current org.apache.hive.service state does not permit
   *           this action
   */
  @Override
  ...
  public synchronized void stop() {
    if (state == STATE.STOPPED ||
      ...
      // started (eg another org.apache.hive.service failing canceled startup)
      return;
    }
   ...
   *          the desired state
   * @throws IllegalStateException
   *           if the org.apache.hive.service state is different from
   *           the desired state
   */
   ...
   *
   * @param newState
   *          new org.apache.hive.service state
   */
