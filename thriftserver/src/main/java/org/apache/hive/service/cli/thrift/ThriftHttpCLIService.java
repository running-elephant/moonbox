...
public class ThriftHttpCLIService extends ThriftCLIService {
  ...
  public void run() {
    try {
      ...
      /* moonbox code start */
      Field hiveConf1 = thriftHttpServlet.getClass().getDeclaredField("isCookieAuthEnabled");
      hiveConf1.setAccessible(true);
      hiveConf1.set(thriftHttpServlet, hiveConf.getBoolVar(ConfVars.HIVE_SERVER2_THRIFT_HTTP_COOKIE_AUTH_ENABLED));
      /* moonbox code end */
